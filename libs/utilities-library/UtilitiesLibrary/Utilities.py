...
class Utilities:
    ...
    def print_friendly_message(self, result):
        """
    ...
    def check_type(self, actual, expect):
        try:
    ...
    def verify_text_with_regEx(self, expected: str, actual: str, conj="??????") -> bool:
        """
    ...
    def get_list_testdata(self, path: str, filetype: str) -> list:
        """
    ...
    def upload_image_without_data(self, url, filepath):
        """
    ...
    def generate_request_uid(self, app_id) -> str:
        """
