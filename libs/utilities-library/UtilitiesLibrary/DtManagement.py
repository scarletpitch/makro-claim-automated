...
class DtManagement:
    ...
    def get_now_datetime(self) -> str:
        ...
        """
        try:
            th_now = self.get_current_date_with_local_timezone()
            th_now = str(th_now)
    ...
    def get_now_datetime_iso(self) -> str:
        """
    ...
    def get_now_total_seconds(self) -> int:
        """
    ...
    def get_current_date_with_local_timezone(self):
    ...
    def convert_epoch_to_date_and_time(self, epoch):
        """
    ...
    def get_iso_datetime_tzcus(self) -> str:
        """
    ...
    def get_iso_datetime_ml(self) -> str:
        """
        Custom datetime format (Update from get_current_date_with_local_timezone function).
